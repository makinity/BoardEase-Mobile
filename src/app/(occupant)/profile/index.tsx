...
export default function OccupantProfileScreen() {
  ...
  return (
    <Screen title="Profile">
      <View style={styles.avatarWrap}>
        ...
        <View style={styles.roleBadge}><Text style={styles.roleText}>Occupant</Text></View>
      </View>
...
const styles = StyleSheet.create({
  ...
  roleBadge: { marginTop: 4, paddingHorizontal: 12, paddingVertical: 4, backgroundColor: '#F0FDF4', borderRadius: 999 },
  roleText: { fontSize: 12, fontWeight: '600', color: '#15803D' },
